...
export const modifyInfoPlist = (
  ...
  infoPlist.BatchProfileCustomIdMigrationEnabled = resolveBooleanProps(
    props.enableProfileCustomIDMigration,
    BATCH_DEFAULT_PROFILE_CUSTOM_ID_MIGRATION,
  );
  infoPlist.BatchProfileCustomDataMigrationEnabled = resolveBooleanProps(
    props.enableProfileCustomDataMigration,
    BATCH_DEFAULT_PROFILE_CUSTOM_DATA_MIGRATION,
  );
  infoPlist.BATCH_OPTED_OUT_BY_DEFAULT = resolveBooleanProps(
